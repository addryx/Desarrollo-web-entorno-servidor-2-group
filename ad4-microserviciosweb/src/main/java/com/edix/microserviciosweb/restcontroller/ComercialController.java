...
public class ComercialController {
	...
	/**
	 * El @RequestBody dice: Lo que me va a llegar es un json, me lo pasas a un objeto de esta clase. 
	 * El objeto que me llega me va a llegar con el id del comercial y los demás atributos. 
	 * 
	...
	/**
	 * Los métodos de eliminar hay que devolver un boolean, pero con el JSON es complicado que el cliente lo entienda. 
	 * También puede devolver un String, para que el cliente sepa si se ha eliminado o no. 
	 * @param comercial
	 * @param idComercial
	 * @return
	 */
